            ...
            <tbody>
                ...
                foreach ($result as $row) {
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['t_category_slug']); ?></td>
                        <td>
                            <?php 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! All products, mid level categories, and end level categories under this top level category will be deleted from all related tables including orders, payments, sizes, colors, ratings, etc.</p>
            </div>
